...
namespace AdventOfCodeCS._2015
{
    public class Day16
    {
        public void Run()
        {
            const int childrenGoal = 3;
            const int catsGoal = 7;
            const int samoyedsGoal = 2;
            const int pomeraniansGoal = 3;
            const int akitasGoal = 0;
            const int vizslasGoal = 0;
            const int goldfishGoal = 5;
            const int treesGoal = 3;
            const int carsGoal = 2;
            const int perfumesGoal = 1;
            
            var lines = new Regex("[\\:\\,]").Replace(Input, String.Empty).Split('\n');
            var index = 1;
            var bestIndex = 0;
            var bestScore = 0;
